                            ...
                            url: (
									editor_name == 'environment_name' ?
									 ...
									 : (
										editor_name == 'svc_id' ? 
										 PP.config.cmdb_api_path + 'service_instance/?type!=environment'
										: ( editor_name =='roles'? PP.config.cmdb_api_path + 'role/'
										    : ( editor_name == 'provisioning_config' ? PP.config.cmdb_api_path + 'provisioning_config/' : 
											PP.config.cmdb_api_path + 'column_lkup/' + opts.entity + '/' + editor_name
										      )
										  )
									  )
								 ),
